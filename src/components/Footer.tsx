    ...
    <footer className="w-full text-gray-700 bg-gray-100 body-font">
      <div className="container flex flex-col flex-wrap px-5 py-12 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          <img src="https://see.fontimg.com/api/renderfont4/9YVZK/eyJyIjoiZnMiLCJoIjo4NiwidyI6MjAwMCwiZnMiOjQzLCJmZ2MiOiIjMEUwRTBFIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/VmlzdWFsIERlc2lnbiBQb3J0Zm9saW8/autumn-flowers.png" />
