const Footer = () => {
  return (
    <footer className="w-full bg-black body-font">
      <div className="container flex flex-col flex-wrap px-5 py-12 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          <img src="https://see.fontimg.com/api/renderfont4/9YVZK/eyJyIjoiZnMiLCJoIjo1NiwidyI6MjAwMCwiZnMiOjI4LCJmZ2MiOiIjRkZGRkZGIiwiYmdjIjoiI0JEQkNCQyIsInQiOjF9/VmlzdWFsIERlc2lnbiBQb3J0Zm9saW8/autumn-flowers.png" />
        ...
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              <li className="mt-3">
                <a className="text-gray-500 cursor-pointer hover:text-gray-700">Company</a>
              </li>
            </nav>
          </div>
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              <li className="mt-3">
                <a className="text-gray-500 cursor-pointer hover:text-gray-700">Release Updates</a>
              </li>
            </nav>
          </div>
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              <li className="mt-3">
                <a className="text-gray-500 cursor-pointer hover:text-gray-700">Terms &amp; Privacy</a>
              </li>
            </nav>
          </div>
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              <li className="mt-3">
                <a className="text-gray-500 cursor-pointer hover:text-gray-700">Send a Message</a>
              </li>
            </nav>
          </div>
        </div>
